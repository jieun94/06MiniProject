...
function fncAddPurchase() {
	...
	var maxNum = document.detailForm.maxNum.value;
	if(prodNum > maxNum){
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="tranNum" 	class="ct_input_g" 
						style="width: 100px; height: 19px" maxLength="20" value="1" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="receiverAddr" class="ct_input_g" 
							style="width: 300px; height: 19px" maxLength="20" value="${user.addr}" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
